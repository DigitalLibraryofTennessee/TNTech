...
{{if(isBlank(cells['dcterms.creator 5'].value), '', '<name><namePart>' + cells['dcterms.creator 5'].value + '</namePart><role><roleTerm authority="marcrelator" valueURI="http://id.loc.gov/vocabulary/relators/cre">Creator</roleTerm></role></name>')}}
{{if(isBlank(cells['dcterms.creator 6'].value), '', '<name><namePart>' + cells['dcterms.creator 6'].value + '</namePart><role><roleTerm authority="marcrelator" valueURI="http://id.loc.gov/vocabulary/relators/cre">Creator</roleTerm></role></name>')}}
{{if(isBlank(cells['dcterms.creator 7'].value), '', '<name><namePart>' + cells['dcterms.creator 7'].value + '</namePart><role><roleTerm authority="marcrelator" valueURI="http://id.loc.gov/vocabulary/relators/cre">Creator</roleTerm></role></name>')}}
{{if(isBlank(cells['dcterms.creator 8'].value), '', '<name><namePart>' + cells['dcterms.creator 8'].value + '</namePart><role><roleTerm authority="marcrelator" valueURI="http://id.loc.gov/vocabulary/relators/cre">Creator</roleTerm></role></name>')}}
